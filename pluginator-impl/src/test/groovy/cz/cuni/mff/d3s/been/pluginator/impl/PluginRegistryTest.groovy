...
class PluginRegistryTest extends Specification {
    ...
    def setup() {
        registry = new PluginatorRegistry()
    }
    ...
    def 'get service'() {
        given:
            ...
            (registry as PluginatorRegistry).@registeredServices = [serviceReference]
    ...
    def 'get all services by interface and name'() {
        given:
            ...
            (registry as PluginatorRegistry).@registeredServices = [
                    serviceReference1,
                    serviceReference2,
                    serviceReference3
            ]
    ...
    def 'register service'() {
        ...
        then:
            (registry as PluginatorRegistry).@registeredServices.size() == 1
            (registry as PluginatorRegistry).@registeredServices*.serviceInstance == [installedService]
            (registry as PluginatorRegistry).@registeredServices*.serviceInterface == [interfaze]
            (registry as PluginatorRegistry).@registeredServices*.serviceName == [name]
